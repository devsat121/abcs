#!/bin/sh
# FIXED: Replaced broken 3-line stub with proper Gradle 8.x wrapper script.
# Original stub used $JAVA_HOME directly with no fallback and no APP_HOME
# resolution, causing CI failures before any build task could execute.
